...
exports.addProduct = async (req, res) => {
  ...
  return res.status(201).json({ status: 'sucess', product })
}
...
exports.deleteProduct = async (req, res) => {
  ...
  if (!product) {
    return res.status(404).json({ status: 'fail', msg: 'product not found.' })
  }

  res.status(200).json({ status: 'sucess', msg: 'product deleted sucessfully' })
}
...
exports.searchProducts = async (req, res) => {
  ...
  if (!name) {
    return res
      .status(400)
      .json({ status: 'fail', msg: 'Please provide the keyword' })
  }
...
exports.getProductByLocation = async (req, res) => {
  ...
  if (products.length == 0) {
    return res.status(404).json({ status: 'fail', msg: 'No product found.' })
  }
  return res
    .status(200)
    .json({ status: 'sucess', msg: 'products fetched.', products })
}

exports.getProductByShop = async (req, res) => {
  const { shop_id } = req.params
  if (!shop_id) {
    return res.status(404).json({ status: 'fail', msg: 'No Shop Found.' })
  }
  ...
  return res
    .status(200)
    .json({ status: 'sucess', msg: 'shops product fetched.', products })
}
...
exports.getProduct = async (req, res) => {
  ...
  return res
    .status(200)
    .json({ status: 'sucess', msg: 'shops fetched.', product })
}
...
exports.getSearchProduct = async (req, res) => {
  ...
  return res
    .status(200)
    .json({ status: 'sucess', msg: 'product fetched.', product })
}
