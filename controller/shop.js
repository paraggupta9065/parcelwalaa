...
exports.updateShops = async (req, res) => {
  ...
  res
    .status(200)
    .json({ status: 'sucess', msg: 'shop updated successfully', shop: shop })
}
...
exports.deleteShops = async (req, res) => {
  ...
  return res
    .status(200)
    .json({ status: 'sucess', msg: 'shop deleted successfully' })
}
...
exports.getShops = async (req, res) => {
  ...
  return res
    .status(200)
    .json({ status: 'sucess', msg: 'shop successfully', shops })
}
...
exports.getShop = async (req, res) => {
  ...
  return res
    .status(200)
    .json({ status: 'sucess', msg: 'shop successfully', shop })
}
...
exports.getStoresByPincode = async (req, res) => {
  ...
  return res
    .status(200)
    .json({ status: 'sucess', msg: 'shop fetched successfully', shops })
}
...
exports.verifyShop = async (req, res) => {
  ...
  res.status(200).json({ status: 'sucess', msg: 'Shop Verified' })
}
exports.getUnverifiedShop = async (req, res) => {
  const shops = await shopModel.find({ isVerified: false })
  if (!shops) {
    res.status(404).json({ status: 'fail', msg: 'All Shop Are Verified' })
  }
  res.status(200).json({ status: 'sucess', msg: 'Shop Fecthed', shops })
}
...
exports.getOrdersReport = async (req, res) => {
  ...
  res.status(200).json({ status: 'sucess', msg: 'Order Fetched', orders })
}
...
exports.setCategories = async (req, res) => {
  ...
  res.status(200).json({ status: 'sucess', msg: 'Categories updated' })
}
