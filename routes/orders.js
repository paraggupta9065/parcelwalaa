...
const { getOrdersShops, getOrders, updateStatus, getOrderByCustomer, getPreviousOrders, getOrder } = require("../controller/orders");
const { isShop } = require("../middleware/isShop");
const { isLoggedIn } = require("../middleware/user");
const router = express.Router();
router.route("/get_orders").get(isLoggedIn, getOrders);
router.route("/get_orders/:id").get(isLoggedIn, isShop, getOrder);
